...
const Home = () => {
  ...
  return (
    <div className="home">
      ...
      <main>
        <ProductCard productId="afncsidvy2e8713" photo="https://m.media-amazon.com/images/I/71S4sIPFvBL._SX679_.jpg" name="MacBook" price={150000} stock={45} handler={addToCartHandler}/>
